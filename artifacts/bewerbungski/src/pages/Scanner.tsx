  ...
  return (
    <Layout>
      <div style={{ maxWidth: 820, margin: "0 auto", padding: "28px 16px 60px" }}>
        <h1 style={{ fontSize: 26, fontWeight: 800, marginBottom: 8 }}>🔎 {t("scanner.title")}</h1>
        ...
        <div className="card">
          ...
          <textarea
            ...
            placeholder={t("scanner.cvPlaceholder")}
            rows={10}
          ...
          <button className="btn btn-p" style={{ marginTop: 16 }} onClick={analyze} disabled={busy}>
