/**
 * Dekorative Hintergrund-Layer für das Anschreiben — identisch zur DECO-Map
 * der CV-Vorlagen in `artifacts/bewerbungski/src/lib/buildCVHTML.ts`.
 * Nur statische divs mit Gradients/border-radius (keine externen Ressourcen),
 * damit die PDF-Erzeugung ohne Netzwerkzugriffe funktioniert.
 *
 * DIN-5008-Lesbarkeit: Alle Layer liegen mit z-index:-1 hinter dem Text und
 * sind bewusst dezent (nur Rand-/Hintergrundbereiche).
 */
const DA = "position:absolute;z-index:-1;pointer-events:none;";

export const COVER_LETTER_DECO: Record<string, string> = {
